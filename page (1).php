                          ...
                          <div class="row">
                              ...
                              <div class="col-sm-3 col-xs-12">
                                  <div class="top-logo">                      
                                          ...
                                          <?php  query_posts(array('post_type'=>'logo'));
        		...
        		<div class="row wow fadeInUp">
                    ...
                    <div class="col-sm-6">
                        <div class="service_left">
                            ...
                            <a href="<?php the_permalink();?>" class="book_now">Read More</a>
                        </div>
                    </div>
            ...
            <div class="item <?php  if($i==1){ echo 'active';}?>">
                <div class="testimonial4_slide">
                    <div class="row">
                        <div class="col-sm-2">
                            <div class="test-img">
                                <img src="<?php echo  $image[0]; ?>" class="img-circle img-responsive" />
                            </div>
                        </div>
